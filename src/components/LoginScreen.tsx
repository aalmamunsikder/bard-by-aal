    ...
    <div className="min-h-screen w-full flex bg-slate-50 font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-900 relative overflow-hidden flex-col justify-between p-16 text-white">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-4 mb-8">
            <img src="/logo/logo.png" alt="BARD Logo" className="w-16 h-16 object-contain drop-shadow-lg" />
            <div>
              <h2 className="text-xl font-bold tracking-tight leading-tight">Bangladesh Academy for</h2>
              <p className="text-emerald-400 font-bold tracking-wider">Rural Development</p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white relative">
        <div className="w-full max-w-[420px] animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <div className="mb-10">
            <img src="/logo/logo.png" alt="BARD Logo" className="lg:hidden w-16 h-16 object-contain mb-6 mx-auto" />
